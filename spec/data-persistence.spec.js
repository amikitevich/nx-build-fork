        ...
        describe('no id', function () {
            ...
            beforeEach(function () {
                ...
                testing_1.TestBed.configureTestingModule({
                    providers: [TodoEffects, testing_2.provideMockActions(function () { return actions; })],
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = expect;
                            return [4 /*yield*/, testing_3.readAll(testing_1.TestBed.get(TodoEffects).loadTodos)];
                        case 1:
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = expect;
                            return [4 /*yield*/, testing_3.readAll(testing_1.TestBed.get(TodoEffects).loadTodo)];
                        case 1:
                            _a.apply(void 0, [_b.sent()]).toEqual([
